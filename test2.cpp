...
struct solution_struct* best_descent_vns(int nb_indx, struct solution_struct* curt_sln)
{
    ...
    switch (nb_indx)
    {
        ...
        case 3: {
            ...
            //             delta = can_move(bins, &curt_move[0], 4);
            //             if (delta ==  1000) {
            //                 isImproving = true;
            //                 apply_move(4, &curt_move[0], best_neighb);
            //                 return best_neighb;
            //             }
            //             if (delta > best_delta) {
            //                 // cout << "new best delta from 1 1 1: " << delta << endl;
            //                 foo = 0;
            //                 isImproving = true;
            //                 best_delta = delta;
            //                 copy_move(&curt_move[0], &best_move[0]);
            ...
            //         delta = can_move(bins, &curt_move[0], 3);

            //         if (delta == -2) {
            //             isImproving = true;
            //             // cout << "Apply 2-1 swap directly" << endl;
            //             apply_move(3, &curt_move[0], best_neighb);
            //             return best_neighb;
            //         }

            //         if (delta > best_delta) {
            //             // cout << "new best delta from 2 1: " << delta << endl;
            //             foo = 1;
            //             isImproving = true;
            //             best_delta = delta;
            //             copy_move(&curt_move[0], &best_move[0]);
            ...
            //     isImproving = true;
            //     if (foo == 0) {
            //         apply_move(4, &best_move[0], best_neighb);
            //     } else if (foo == 1) {
            //         apply_move(3, &best_move[0], best_neighb);
            //     } else {
            //         cout << "Error" <<endl;
            //     }
            // }    
